...
function StarRating() {
    return (
        <div className="mb-2.5 flex items-center gap-0.5" aria-label="5 out of 5 stars">
            {[...Array(5)].map((_, i) => (
                <svg
                    key={i}
                        ...
                        <div className="mt-4 flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
                            ...
                            <div className="flex items-center gap-1.5">
                                <div className="flex items-center gap-0.5" aria-hidden="true">
                                    {[...Array(5)].map((_, i) => (
                                        <svg key={i} className="h-3.5 w-3.5 shrink-0" viewBox="0 0 20 20" fill="currentColor" style={{ color: "oklch(0.68 0.13 85)" }}>
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                        </svg>
                                    ))}
                                </div>
                                <span className="text-sm font-semibold text-foreground">4.9</span>
                                <span className="text-xs text-foreground/50">Fresha · 300+ reviews</span>
                            </div>
                            ...
                            <div className="flex items-center gap-1.5">
                                <div className="flex items-center gap-0.5" aria-hidden="true">
                                    ...
                                    <svg className="h-3.5 w-3.5 shrink-0" viewBox="0 0 20 20" fill="currentColor" style={{ color: "oklch(0.68 0.13 85)", opacity: 0.35 }}>
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                    </svg>
                                </div>
                                <span className="text-sm font-semibold text-foreground">4.4</span>
                                <span className="text-xs text-foreground/50">Google</span>
                            </div>
                        </div>
                    </div>
                </motion.div>
