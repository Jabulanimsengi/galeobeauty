...
export function buildGlobalKeywords(): string[] {
    return dedupeKeywords([
        ...
        "skin treatments harties",
        "skin treatments hartbeesport",
...
export function buildHomepageKeywords(): string[] {
    return dedupeKeywords([
        ...
        "keratin treatment near pretoria",
        "balayage near pretoria",
        ...
        "keratin treatment near sandton",
...
export function buildPricesPageKeywords(): string[] {
    return dedupeKeywords([
        ...
        "beauty treatment prices hartbeesport",
...
export function buildLocationsIndexKeywords(): string[] {
    return dedupeKeywords([
        ...
        "beauty services across hartbeesport",
