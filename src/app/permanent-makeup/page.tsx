...
export const metadata: Metadata = {
    ...
    keywords: [
        "powder pixel brows Hartbeespoort",
        "hybrid brows vs microblading South Africa",
        "lip contour permanent makeup prices",
        "permanent eyeliner top and bottom near me",
        "microblading before and after Pretoria",
        "full lip blush tattoo prices",
        "best microblading results Gauteng",
...
const schemas = [
    generateServiceSchema({
        ...
        description: "Professional semi-permanent makeup including microblading, powder brows, hybrid brows, permanent eyeliner, and lip blush by certified artists at Galeo Beauty in Hartbeespoort.",
        url: "https://www.galeobeauty.com/permanent-makeup",
        image: "https://www.galeobeauty.com/images/services/makeup/makeup_01.jpeg",
        priceRange: "R720 - R2,430",
        offers: [
            { name: "Microblading", price: "R1,350" },
            { name: "Powder Pixel Brows", price: "R1,710" },
            { name: "Hybrid Brows", price: "R1,710" },
            { name: "Permanent Eyeliner", price: "R720" },
            { name: "Full Lip Blush", price: "R2,430" },
            { name: "Lip Liner", price: "R1,710" },
        ],
    }),
    generateBreadcrumbSchema([
        { name: "Home", url: "https://www.galeobeauty.com" },
        { name: "Services", url: "https://www.galeobeauty.com/services" },
        { name: "Permanent Makeup", url: "https://www.galeobeauty.com/permanent-makeup" },
    ]),
    generateFAQSchema([
        { question: "How long does permanent makeup last?", answer: "Permanent makeup at Galeo Beauty lasts 1-3 years depending on the technique. Microblading typically lasts 12-18 months, powder pixel brows last 2-3 years, and permanent eyeliner lasts 2-3 years. A touch-up session 6-8 weeks after the initial treatment is included to perfect the results." },
        { question: "Is microblading painful?", answer: "Most clients describe the sensation as mild scratching. We apply professional topical numbing cream for 20-30 minutes before the procedure to ensure maximum comfort. The process takes 1-2 hours and most clients find it very manageable." },
        { question: "What is the difference between microblading and powder brows?", answer: "Microblading creates ultra-fine hair strokes for a natural look, ideal for filling sparse areas. Powder brows create a soft, powdery makeup effect. Hybrid brows combine both techniques. Powder brows generally last longer (2-3 years vs 12-18 months) and work better on oily skin types." },
    ]),
];
