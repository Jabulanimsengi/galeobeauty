...
export const metadata: Metadata = {
    ...
    keywords: [
        "matric dance makeup Hartbeespoort",
        "matric farewell makeup near me",
        "matric dance hair and makeup Pretoria",
        "matric ball packages prices",
        "how much does matric dance makeup cost",
        "matric farewell beauty packages Gauteng",
        "best matric dance makeup near me",
        "matric afskeid grimering",
    ],
    alternates: {
